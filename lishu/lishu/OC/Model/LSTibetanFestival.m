...
@implementation LSTibetanFestival
...
- (instancetype)initWithYear:(int)year {
    ...
    if (self) {
        ...
        for (int i = 0; i < days; i++) {
            LSCalendarTypeModel *calnedar = [[LSCalendarTypeModel alloc] initWithType:LSCalendarTypeZangli timezone:@"Asia/Shanghai"];
            ...
            if (calnedar.isFestival) {
                ...
                LSTibetanFestivalItem  *item = [[LSTibetanFestivalItem alloc] initWithCalendarModel:calnedar];
...
@implementation LSTibetanFestivalItem
