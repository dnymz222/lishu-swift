...
@interface LSStarMonthViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LSStarMonthViewController
...
- (void)viewDidLoad {
    ...
    [self.star calculateRaAndDec];
    self.navigationItem.title =[[NSBundle mainBundle] localizedStringForKey:self.star.EnglishName value:@"" table:@"lish"];
    ...
    self.astroBody = [[LSStaticAstroBody alloc] initWithRA:self.star.RA dec:self.star.Dec];
