//
//  LSConstellationMonthViewController.m
//  lishu
//
...
@interface LSConstellationMonthViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@property(nonatomic,strong)LSStaticAstroBody *astroBody;
//
...
@implementation LSConstellationMonthViewController
...
- (void)viewDidLoad {
    ...
    [self.constellation  calculateRaAndDec];
    self.navigationItem.title = [[NSBundle mainBundle] localizedStringForKey:self.constellation.englishName value:@"" table:@"lish"];
    ...
    self.astroBody = [[LSStaticAstroBody alloc] initWithRA:self.constellation.RA dec:self.constellation.Dec];
    
    for (LSDay *day in selectLSMonth.daysArray) {
        
        day.staticAstroRiseSetTime = [self.astroBody calculaterisesetWithZeroJd:day.jd location:self.selectLocation.GeoPosition];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell configRisetSetTime:day.staticAstroRiseSetTime day:day];
    return cell;
}
