...
public:
    ...
    float getLatitudeInDegrees(float ScreenYRelative) ;
    CAA2DCoordinate  getScreenLocationFromLatLon(float lat, float lon);
    
    CAA2DCoordinate  getLatLonFromScreenLocation(float x, float y);
